...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Anycubic Kossel - run 'M106 S255' & 'M303 E0 C10 S200'
    ...
    #define DEFAULT_Kp_LIST {  27.41, 27.41}
    #define DEFAULT_Ki_LIST {   1.95,  1.95}
    #define DEFAULT_Kd_LIST {  96.55, 96.55}
  #else
    #define DEFAULT_Kp  27.41
    #define DEFAULT_Ki   1.95
    #define DEFAULT_Kd  96.55
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from pid autotune. "M303 E-1 C8 S60" to run autotune on the bed at 60 degreesC for 8 cycles
    ...
    #define DEFAULT_bedKp 109.57
    #define DEFAULT_bedKi 21.57
    #define DEFAULT_bedKd 371.00
  #endif
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_DIAGONAL_ROD 269.90       // (mm)
  ...
  #define DELTA_ENDSTOP_ADJ { -2.08,-1.38 ,0.0 } // Get these values from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.31, 0.51, -0.81 } // Get these values from G33 auto calibrate
...
#define Z_MIN_ENDSTOP_INVERTING true // V1 is NO, V2 is NC (ANYCUBIC_PROBE_VERSION + 0 == 1)
